...
const PATHS: Record<string, React.ReactNode> = {
  ...
  body: (
    <>
      ...
      <path d="M6 21c.4-5 2.4-8 6-8s5.6 3 6 8M8 13l-2-3m10 3 2-3" />
    </>
  ),
  wind: (
    <>
      <path d="M3 8h11c2.2 0 3.5-1.1 3.5-2.7S16.4 3 15 3c-1.3 0-2.2.7-2.7 1.6" />
      <path d="M3 12h16c1.4 0 2.5 1 2.5 2.3S20.4 17 19 17c-1.2 0-2-.6-2.5-1.5" />
      <path d="M3 16h8c1.7 0 2.8 1 2.8 2.4S12.7 21 11.2 21c-1 0-1.8-.5-2.2-1.2" />
    </>
  ),
